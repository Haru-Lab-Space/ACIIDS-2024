...
class Explainator():
    ...
    def evaluate(
        ...
        **kwargs):
        ...
        # Load dataloader
        self.testing_loader = DataLoader(test_generator, batch_size=self.batch_size, shuffle=self.shuffle, num_workers=kwargs.get('num_workers', 0), drop_last=True)
    ...
    def __testing_step(self):
        ...
        with torch.no_grad():
            for batch, data in enumerate(progress_bar):
                ...
                preds_list, target_list, dict_attn = self.model.explain(data)
